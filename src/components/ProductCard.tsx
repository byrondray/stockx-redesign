  ...
  return (
    <li className='list-none min-w-[200px] max-w-[230px] flex-shrink-0 rounded-md'>
      <div
        ...
        className='relative h-full bg-black border border-gray-800 rounded-md overflow-hidden'
      >
        <Link
          href={product.href}
        ...
        <button
          type='button'
          className='absolute top-2 right-2 w-10 h-10 rounded-full bg-gray-700/50 flex items-center justify-center'
          aria-label='Follow'
        >
          <svg className='w-6 h-6 text-white' viewBox='0 0 50 50'>
            <path
        ...
        <div className='p-3 border-t border-gray-800'>
          <Link
            className='block w-full text-center py-2 text-sm font-medium text-black bg-white hover:bg-gray-100 rounded-md'
            href={`/buy/${product.id}?defaultBuy=true`}
          >
            Buy Now
          </Link>
        </div>
